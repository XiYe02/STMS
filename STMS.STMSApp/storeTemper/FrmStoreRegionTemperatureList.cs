...
{
    public partial class FrmStoreRegionTemperatureList : Form
    {
        public FrmStoreRegionTemperatureList()
        {
            InitializeComponent();
        }
        SRegionTemperBLL rtBLL = new SRegionTemperBLL();
        private void FrmStoreRegionTemperatureList_Load(object sender, EventArgs e)
        {
        ...
        {
             foreach(Control c in flpRegionList.Controls)
            {
                UStoreRegionBox uBox = c as UStoreRegionBox;
